...
<html>
<head> <title> [zipCheckSave.jsp] </title> 
	<style type="text/css">
	   input,b{ font-size:20pt; font-weight:bold; }
	   a{font-size:20pt; text-decoration:none; font-weight:bold; }
	   a:hover{font-size:24pt; text-decoration:underline; font-weight:bold; }
	</style>
...
<% 
 ...
 %>
 <br>
 <a href="javascript:sendAddress('<%= data0  %>',  '<%= data1 %>', '<%= data2 %>' , '<%= data3 %>')"> 
   <%= data1 %> &nbsp;  <%= data2 %> &nbsp; <%= data3 %>
 </a>	
 <% 	  	
  	  }while(RS.next()==true);
